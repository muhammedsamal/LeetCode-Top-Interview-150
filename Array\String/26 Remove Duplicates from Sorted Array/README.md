...
1. Sorted array - duplicates will be close to each other
1. keep the relative order of elements
1. return the number of unique elements
...
> to code
- use two pointers to compare the `curr` and `prevs` of `nums`
